...
def make_single_name():
    return nameset_c.make_name(n_candidates=300, pref_candidate=2, max_attempts=10, exclude_real_names=True, add_to_history=False, exclude_history=False)
